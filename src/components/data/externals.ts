export const externals = {
  "Morosidad Patronos CCSS": "https://aissfa.ccss.sa.cr/moroso/",
  "Verificación de documentos CCSS":
  ...
  "Consulta Patronos Morosos IMAS":
    "https://web.imas.go.cr/morosos/#/consulta-morosos",
  "Notarios de Costa Rica": "https://consulta.dnn.go.cr:8443/",
  "Archivo Nacional": "http://201.196.50.12/equery/#",
  "Envío de Índices Notariales": "https://www.index.co.cr/inicio.aspx",
  ...
  "Procedimiento de protección de derechos en la PRODHAB":
    "http://prodhab.go.cr/procedimientosdeprote/",
  "Gestión en Línea del Poder Judicial":
    "https://pjenlinea.poder-judicial.go.cr/GestionEnLinea/inicio/tramitesfrecuentes",
  "Base de Datos de Marcas a Nivel Mundial":
    "https://branddb.wipo.int/en/quicksearch?sort=score%20desc&amp;start=0&amp;rows=30&amp;asStructure=%7B%22_id%22:%22e1d6%22,%22boolean%22:%22AND%22,%22bricks%22:%5B%5D%7D&amp;_=1718333419382",
  "Marcas en el Registro de Marcas":
    "https://rpi.rnp.go.cr/wipofileacepto/xhtml/sesion/terminos_wp.xhtml",
};
